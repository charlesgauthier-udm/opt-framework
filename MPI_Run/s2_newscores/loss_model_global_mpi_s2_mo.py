...
def loss(params):
    ...
    if rank == 0:
        init = xr.open_dataset('/home/chargaut/scratch/formating_global_files/formating_last/rsFile_modified.nc') # Restart file
...
# Computing the rest of variables needed for model run
    ...
    # START MODEL RUN
    arg1, arg2, arg3 = func_model_s2.model(params,ncell,iccp2,ignd,litrmass,soilcmass,tf,delt,ndays, thice, thpor, thliq,
    ...
    if rank == 0:
        ...
        # Computing score
        alpha = 0.5
        #score = alpha*wosis_score[0] + (1-alpha)*srdb_score[0]
