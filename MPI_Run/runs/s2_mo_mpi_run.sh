...
# add --outfile [name_of_the_file.py] to the mpiexec call to the main script, e.g. --outfile=s2_mo_opt_out_2900.pkl
# cp -v $MPI_Run/outputs/s2_mo_opt_out_2900.pkl ./

mpiexec -n 32 python3 main_s2_mo.py --prior=$MPI_Run/prior_classic_scenario1w.txt --loss=$MPI_Run/s2_newscores/loss_model_global_mpi_s2_mo.py --algo=tpe --iter=100


cp -v ./s2_mo_opt_out_* $MPI_Run/outputs
