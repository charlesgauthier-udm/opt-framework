...
# Computing the rest of variables needed for model run
    ...
    # START MODEL RUN
    arg1, arg2, arg3 = func_model_sc.model(params,ncell,iccp2,ignd,litrmass,soilcmass,tf,delt,ndays, thice, thpor, thliq,
    ...
    if rank == 0:
        ...
        # Computing score
        alpha = 0.5
        eo_score = alpha * eo_csoil + (1-alpha) * eo_resp
        mo_score = alpha * mo_csoil + (1-alpha) * mo_resp
