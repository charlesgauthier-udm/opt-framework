...
import emcee
import os
import loss_model_global_mpi_scores_eo
import pickle
...
def a_tpe(prior, f, args):
    ...
    #trials = Trials()
    trials = pickle.load(open("s3_eo_opt_out_2900.pkl", "rb"))
    best = fmin(
        fn=loss_model_global_mpi_scores_eo.loss,           # Objective Function to optimize
